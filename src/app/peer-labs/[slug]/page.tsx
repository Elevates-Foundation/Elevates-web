...
import { getPeerLabBySlug } from "@/data/peer-labs";
import {
  fetchPeerLabBySlug,
  fetchPeerLabSlugs,
} from "@/lib/data/peer-labs";
...
export async function generateStaticParams() {
  const slugs = await fetchPeerLabSlugs();
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const lab =
    (await fetchPeerLabBySlug(resolvedParams.slug)) ??
    getPeerLabBySlug(resolvedParams.slug);
