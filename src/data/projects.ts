...
export const ALSO_BUILT_ARCHIVE: Array<{
  name: string;
  year: string;
  status: "paused" | "archived" | "never-launched" | "live-unmaintained" | "live-incomplete";
  reason: string;
  repo?: string;
  slug?: string;
}> = [
  {
    ...
    year: "2026",
    status: "live-incomplete",
    reason: "Rebuilt in 1 hour on stage. Live and functional on Vercel, carrying placeholder statistics requiring institutional data audit.",
    slug: "celestia",
  },
  {
    name: "RoadUndo",
